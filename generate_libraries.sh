...
bunx nx g @nx/js:lib apps/web/feature-interactions --name=web-feature-interactions --importPath=@weople/web/feature-interactions --bundler=vite --unitTestRunner=vitest --strict --tags=type:feature,scope:web,domain:interactions --projectNameAndRootFormat=as-provided
bunx nx g @nx/js:lib apps/web/feature-followups --name=web-feature-followups --importPath=@weople/web/feature-followups --bundler=vite --unitTestRunner=vitest --strict --tags=type:feature,scope:web,domain:followups --projectNameAndRootFormat=as-provided
...
bunx nx g @nx/react-native:lib apps/mobile/feature-auth --name=mobile-feature-auth --importPath=@weople/mobile/feature-auth --buildable --unitTestRunner=jest --strict --tags=type:feature,scope:mobile,domain:auth --projectNameAndRootFormat=as-provided
